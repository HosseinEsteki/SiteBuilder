...
class BlockRegistry
{
    public function all(): array
    {
        return [
            ...
            'product_gallery' => ['type' => 'product_gallery', 'label' => 'Product Gallery', 'view' => 'theme::blocks.product-gallery', 'settings' => ['image_ratio' => '1/1', 'image_fit' => 'contain', 'show_thumbnails' => true, 'show_discount_badge' => true]],
            'product_summary' => ['type' => 'product_summary', 'label' => 'Product Summary', 'view' => 'theme::blocks.product-summary', 'settings' => ['show_brand' => true, 'show_category' => true, 'show_sku' => true, 'show_short_description' => true, 'show_stock' => true]],
            ...
            'product_archive_header' => ['type' => 'product_archive_header', 'label' => 'Product archive header', 'view' => 'theme::blocks.product-archive-header', 'settings' => ['show_description' => true, 'show_image' => true, 'show_result_count' => true, 'show_breadcrumbs' => true, 'alignment' => 'right', 'variant' => 'default']],
            'product_listing_grid' => ['type' => 'product_listing_grid', 'label' => 'Product listing grid', 'view' => 'theme::blocks.product-listing-grid', 'settings' => ['variant' => 'default', 'desktop_columns' => 4, 'tablet_columns' => 3, 'mobile_columns' => 2, 'show_brand' => true, 'show_discount' => true, 'show_stock' => true, 'show_button' => false, 'show_result_count' => false, 'empty_title' => 'محصولی یافت نشد', 'empty_description' => 'فیلترها یا عبارت جستجو را تغییر دهید.']],
